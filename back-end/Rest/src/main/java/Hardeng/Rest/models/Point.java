...
public class Point {
    ...
    public enum Condition {
        OPERATIONAL(0), DOWN(-1), UNDER_REPAIRS(1), NEEDS_CHECK(2), UNDER_CONSTRUCTION(3);
     ...
     */
    Point(Double longitude, Double latitude, Integer operatorId , Integer maxOutput, Integer condition,  Boolean isOccupied) {
     ...
     */
    Point(Double longitude, Double latitude, Integer operatorId, Integer maxOutput) {
        this.longitude = longitude; this.latitude = latitude; this.operatorId = operatorId; this.maxOutput = maxOutput;
